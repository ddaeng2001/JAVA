...
//				
//				while (true) {
//					System.out.println(rnd.nextInt(45)  + 1); //N%45 과 동일 (0~44)
//											//원래는 0~44이나 +1 떄문에 1~45범위의 수 중에서 랜덤하게 콘솔 창에 도출됨
//					Thread.sleep(500); //Thread로 0.5초씩 일시정지하는 명령어
//				}

				// 02 Math.random();
				while (true) {
					System.out.println( (int)(Math.random()*100)%45 + 1 );
									//강제 형변환	//.random() : double형, *100하면 두 자리 수가 나옴
...
//				입력: 1234
//				저장
//				int reverse = 4321; //point : 문자가 아닌 숫자일 것!
//				출력 : 4321
